<template>
  <section
    :id="id"
    class="section section-cards-grid py-5 position-relative overflow-hidden"
    :class="schemeClass"
  >
    <div
      v-if="backgroundImg"
    ...
    <div :class="containerClass">
      ...
      <div class="row g-4" :class="justifyClass">
        ...
        >
          <article
            class="card-item h-100 rounded-4 overflow-hidden"
...
const props = defineProps({
  id: { type: String, default: 'section-cards-grid' },
