<!-- src/sections/SectionMenu2.vue -->
<template>
  <section
    :id="id"
    class="section section-menu-2 position-relative overflow-hidden py-5"
    :class="schemeClass"
  >
    <!-- Fondo opcional -->
    <div
    ...
    <div :class="[fluid ? 'container-fluid' : 'container', 'position-relative']">
      ...
      >
        <article
          ...
          :key="i"
          class="menu-card d-flex flex-column rounded-4 shadow-sm overflow-hidden"
          data-aos="fade-up"
...
const props = defineProps({
  id: { type: String, default: 'section-menu-2' },
...
// detección dinámica del overflow real
