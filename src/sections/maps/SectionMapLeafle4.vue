  ...
  >
    ...
    <div :class="[fluid ? 'container-fluid' : 'container', 'position-relative']">
      ...
      <div class="row align-items-start g-4 g-lg-5">
        ...
        <div class="col-12 col-lg-6" data-aos="fade-left" data-aos-duration="700" data-aos-delay="100">
          <!-- 🏢 Información -->
          <div class="venue-info rounded-4 shadow-sm p-4">
            <div class="text-center mb-4">
              ...
              <!-- Redes -->
              <div v-if="location.social?.length" class="d-flex justify-content-center gap-3 mb-4">
                <a
            ...
            <div class="text-center mt-4">
              <button @click="showRoute" class="btn btn-outline me-2 mb-2">
