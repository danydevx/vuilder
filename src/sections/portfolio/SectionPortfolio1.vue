<template>
  <section
    :id="id"
    class="section section-portfolio-grid py-5 position-relative overflow-hidden"
    :class="schemeClass"
  >
    <div
      v-if="backgroundImg"
    ...
    <div :class="containerClass">
      ...
      <div class="row g-4" :class="justifyClass">
        ...
        >
          <article
            class="project-card h-100 rounded-4 overflow-hidden"
          ...
          >
            ...
            <div class="project-body p-4">
              <div class="project-meta d-flex align-items-center gap-2 mb-2">
              ...
              <h3 v-if="project.title" class="project-title h6 fw-semibold mb-2">
                {{ project.title }}
              </h3>

              <p v-if="project.description" class="project-description small  mb-3">
                {{ project.description }}
              </p>

              <div v-if="project.tags?.length" class="project-tags d-flex flex-wrap gap-1">
                <span
...
const props = defineProps({
  id: { type: String, default: 'section-portfolio-grid' },
