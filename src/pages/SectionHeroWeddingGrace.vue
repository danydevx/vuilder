...
<template>
  <section
    ...
    class="section-hero-wedding position-relative overflow-hidden text-center"
    :class="schemeClass"
    ref="sectionRef"
  >
    <!-- Fondo con parallax -->
    ...
    <div class="inner container position-relative z-1 d-flex flex-column justify-content-center align-items-center min-vh-100">
      ...
      <!-- Encabezados -->
      <p class="kicker" data-aos="fade-up" data-aos-duration="600">Diseño y desarrollo web</p>
      <h1
        class="hero-names fw-bold mb-2"
        data-aos="fade-up"
        data-aos-duration="700"
        data-aos-delay="60"
      >
    ...
    <div class="shape-separator" aria-hidden="true">
      <svg viewBox="0 0 1440 120" preserveAspectRatio="none" class="w-100 h-100">
        <path
          class="shape-path"
          d="M0,72 C240,120 480,40 720,70 C960,96 1200,120 1440,84 L1440,120 L0,120 Z"
        />
      </svg>
    </div>
  </section>
...
const props = defineProps({
  scheme: {
    type: String,
    default: '',
    validator: v => ['', 'light', 'dark', 'default-light', 'default-neutral', 'rose-gold', 'rose-vintage', 'rose-berry', 'rose-blush', 'emerald-light', 'emerald-dark'].includes(v)
  },
  ...
  backgroundImg: { type: String, default: 'https://placehold.com/1920x1200/jpg?text=Fondo+Boda' },
  ...
  petals: {
    type: Array,
    default: () => ([
      { src: 'https://placehold.com/96x96/png?text=🌸', top: '8%',  left: '12%', size: '52px', dur: '11s', delay: '0s' },
      { src: 'https://placehold.com/96x96/png?text=🌺', top: '18%', left: '82%', size: '56px', dur: '13s', delay: '.2s' },
      { src: 'https://placehold.com/96x96/png?text=💐', top: '28%', left: '6%',  size: '48px', dur: '12s', delay: '.4s' },
      { src: 'https://placehold.com/96x96/png?text=🌸', top: '68%', left: '88%', size: '60px', dur: '14s', delay: '.1s' },
      { src: 'https://placehold.com/96x96/png?text=🌺', top: '76%', left: '18%', size: '50px', dur: '12s', delay: '.6s' },
      { src: 'https://placehold.com/96x96/png?text=💐', top: '12%', left: '50%', size: '44px', dur: '10s', delay: '.3s' }
    ])
  }
})
...
.btn-scheme:hover {
  ...
  box-shadow: 0 6px 14px color-mix(in oklab, var(--accent), transparent 76%);
}
.btn-scheme:active {
